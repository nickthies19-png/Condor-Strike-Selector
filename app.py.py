...
with st.sidebar:
    ...
    pct_OTM_input = st.sidebar.number_input("Percent OTM)", value=2.0, step=0.1, format="%.2f") # stores default value of 2%, converts decimal to % for more natural user experience
    ...
    risk_free_rate_input = st.sidebar.number_input("Risk-Free Rate (decimal)", value=5.0, step=0.1, format="%.2f") # stores default value of 5%, converts decimal to % for more natural user experience
